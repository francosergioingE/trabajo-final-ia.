# -*- coding: utf-8 -*-
"""PROYECTO FINAL_IA_SERGIO FRANCO

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nSoat8-mIDWHlGPNTRRnLJySrFNLzBTL

## PROYECTO IA
### CLASIFICADOR DE IMAGENES : PERROS Y GATOS
---
...
datos, metDatos = tfds.load('cats_vs_dogs', as_supervised=True, with_info=True)

#Imprimir los metadatos para revisarlos
metDatos

#Una forma de mostrar 5 ejemplos del set
tfds.as_dataframe(datos['train'].take(5), metDatos)

#Otra forma de mostrar ejemplos del set
tfds.show_examples(datos['train'], metDatos)
...
modeloDenso = tf.keras.models.Sequential([
  ...
  tf.keras.layers.Dense(150, activation='relu'),
  tf.keras.layers.Dense(1, activation='sigmoid') ## 1 o 0
])
...
modeloDenso.compile(optimizer='adam',
                    loss='binary_crossentropy', # 1 o 0
                    metrics=['accuracy'])
